    ...
    if (param == "availableRewards") {
      ...
      for (i = 0; i < txids.length; i++) {
        ...
        availableRewardsForAddr =
          availableRewardsForAddr + availableRewardsForTx;
      }
      res.jsonp(availableRewardsForAddr);
    }else {
